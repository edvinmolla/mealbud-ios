...
var drinkItemList: [DrinkItem] = [
    ...
    .init(title: "Mighty Mango", description: "Naked Juice - Mighty Orange Mango (Mango Puree, Apple Juice, Orange Juice, Banana Puree, Lemon Juice, Natural Flavors", price: "$5.00", imageName: "mightmango-smoothie"),
